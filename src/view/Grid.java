...
public class Grid extends JComponent{
	...
	public void drawHorizontalDashedLine(Graphics2D pen, int startX, int endX, int Y){
	...
	public void drawVerticalDashedLine(Graphics2D pen, int startY, int endY, int X){
		pen.setColor(Color.BLACK);
		System.out.println("Actually drawing Grid");
